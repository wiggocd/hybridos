...
void idt_init(void) {
    ...
    extern int irq0(void) asm("irq0");
    extern int irq1(void) asm("irq1");
    extern int irq2(void) asm("irq2");
    extern int irq3(void) asm("irq3");
    extern int irq4(void) asm("irq4");
    extern int irq5(void) asm("irq5");
    extern int irq6(void) asm("irq6");
    extern int irq7(void) asm("irq7");
    extern int irq8(void) asm("irq8");
    extern int irq9(void) asm("irq9");
    extern int irq10(void) asm("irq10");
    extern int irq11(void) asm("irq11");
    extern int irq12(void) asm("irq12");
    extern int irq13(void) asm("irq13");
    extern int irq14(void) asm("irq14");
    extern int irq15(void) asm("irq15");
